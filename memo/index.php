  ...
  <div class="h-100">
    <div class="row h-100 m-0 p-0">
      <div class="col-3 h-100 m-0 p-0 border-left border-right border-gray">
        <div class="left-memo-menu d-flex justfy-content-between pt-2">
          <div class="pl-3 pt-2">
        ...
        <div class="left-memo-list list-group-flush p-0">
          <?php if(empty($memos)): ?>
            <div class="pl-3 pt-3h5 text-info text-center">
      ...
      <div class="col-9 h-100">
        <?php if(isset($_SESSION['select_memo'])): ?>
          <form class="w-100 h-100" method="POST">
            ...
            <input type="text" name="edit_title" id="memo-title" placeholder="タイトルを入力する..." value="<?php echo $edit_title; ?>" />
            <textarea name="edit_content" id="memo-content" placeholder="内容を入力する..."><?php echo $edit_content; ?></textarea>
          </form>
        <?php else : ?>
